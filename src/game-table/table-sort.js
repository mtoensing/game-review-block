document.addEventListener('DOMContentLoaded', function () {
    function sortTable(table, column, asc = true) {
        ...
        const sortedRows = rows.sort((a, b) => {
            ...
            const aColTime = a.querySelector(`td:nth-child(${column + 1})`).getAttribute('data-time');
            const bColTime = b.querySelector(`td:nth-child(${column + 1})`).getAttribute('data-time');
